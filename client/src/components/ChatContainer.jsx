...
export default function ChatContainer() {
  ...
  useEffect(() => {
    if (selectedUser) {
      selectedUserMessage(selectedUser._id);
    }
  }, [selectedUser]);
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-bg">
      ...
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        ...
        />
        <p className="flex-1 text-lg text-white flex flex-col gap-1">
          ...
          {typingUser === selectedUser._id && (
            <span className="text-sm text-gray-300 italic animate-pulse">
              typing...
            </span>
          )}
        </p>
          ...
          return (
            ...
            >
              {msg.image ? (
                ...
                <p
                  className={`p-2 max-w-[200px] rounded-lg md:text-sm font-light mb-8 break-all bg-violet-500/30 text-white ${
